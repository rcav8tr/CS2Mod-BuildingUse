...
### Buildings For Rent
For residential, commercial, extractor, industrial, warehouse, and office buildings that are available to rent,
...
All building types for residential, commercial, extractor, industrial, warehouse, and office include both growable buildings and signature buildings.

### Employees Infoview
- Number of employees as a percent of employee capacity.
- Residential building use is households instead of employees.
- Warehouses do not have employees.
...
- Residential Car, Commercial Truck, Extractor Truck, Industrial Truck, Warehouse Truck, Office Truck, and 3 Parked do not have vehicles in maintenance.
...
- Warehouses do not have efficiency.
...
- Zone Color:  Building colors are set according to their respective zone type:
  residential = green, commercial = blue, extractor/industrial/warehouse = yellow, and office = purple.
